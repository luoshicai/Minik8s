...
const (
	...
	KubeletApiServerService_CreateService_FullMethodName = "/kubelet_for_apiserver.kubeletApiServerService/CreateService"
	KubeletApiServerService_DeleteService_FullMethodName = "/kubelet_for_apiserver.kubeletApiServerService/DeleteService"
	KubeletApiServerService_CreateDns_FullMethodName     = "/kubelet_for_apiserver.kubeletApiServerService/CreateDns"
	KubeletApiServerService_DeleteDns_FullMethodName     = "/kubelet_for_apiserver.kubeletApiServerService/DeleteDns"
)
...
type KubeletApiServerServiceClient interface {
	...
	CreateService(ctx context.Context, in *ApplyServiceRequest2, opts ...grpc.CallOption) (*StatusResponse, error)
	DeleteService(ctx context.Context, in *DeleteServiceRequest2, opts ...grpc.CallOption) (*StatusResponse, error)
	CreateDns(ctx context.Context, in *ApplyDnsRequest, opts ...grpc.CallOption) (*StatusResponse, error)
...
func (c *kubeletApiServerServiceClient) CreateService(ctx context.Context, in *ApplyServiceRequest2, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, KubeletApiServerService_CreateService_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kubeletApiServerServiceClient) DeleteService(ctx context.Context, in *DeleteServiceRequest2, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, KubeletApiServerService_DeleteService_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kubeletApiServerServiceClient) CreateDns(ctx context.Context, in *ApplyDnsRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, KubeletApiServerService_CreateDns_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kubeletApiServerServiceClient) DeleteDns(ctx context.Context, in *DeleteDnsRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, KubeletApiServerService_DeleteDns_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KubeletApiServerServiceServer interface {
	...
	CreateService(context.Context, *ApplyServiceRequest2) (*StatusResponse, error)
	DeleteService(context.Context, *DeleteServiceRequest2) (*StatusResponse, error)
	CreateDns(context.Context, *ApplyDnsRequest) (*StatusResponse, error)
...
func (UnimplementedKubeletApiServerServiceServer) CreateService(context.Context, *ApplyServiceRequest2) (*StatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateService not implemented")
}
func (UnimplementedKubeletApiServerServiceServer) DeleteService(context.Context, *DeleteServiceRequest2) (*StatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteService not implemented")
}
func (UnimplementedKubeletApiServerServiceServer) CreateDns(context.Context, *ApplyDnsRequest) (*StatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDns not implemented")
}
func (UnimplementedKubeletApiServerServiceServer) DeleteDns(context.Context, *DeleteDnsRequest) (*StatusResponse, error) {
...
func _KubeletApiServerService_CreateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyServiceRequest2)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KubeletApiServerServiceServer).CreateService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KubeletApiServerService_CreateService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeletApiServerServiceServer).CreateService(ctx, req.(*ApplyServiceRequest2))
	}
	return interceptor(ctx, in, info, handler)
}

func _KubeletApiServerService_DeleteService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteServiceRequest2)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KubeletApiServerServiceServer).DeleteService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KubeletApiServerService_DeleteService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeletApiServerServiceServer).DeleteService(ctx, req.(*DeleteServiceRequest2))
	}
	return interceptor(ctx, in, info, handler)
}

func _KubeletApiServerService_CreateDns_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyDnsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KubeletApiServerServiceServer).CreateDns(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KubeletApiServerService_CreateDns_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeletApiServerServiceServer).CreateDns(ctx, req.(*ApplyDnsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _KubeletApiServerService_DeleteDns_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteDnsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KubeletApiServerServiceServer).DeleteDns(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KubeletApiServerService_DeleteDns_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubeletApiServerServiceServer).DeleteDns(ctx, req.(*DeleteDnsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KubeletApiServerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _KubeletApiServerService_CreateService_Handler,
		},
		{
			MethodName: "DeleteService",
			Handler:    _KubeletApiServerService_DeleteService_Handler,
		},
		{
			MethodName: "CreateDns",
			Handler:    _KubeletApiServerService_CreateDns_Handler,
		},
		{
			MethodName: "DeleteDns",
			Handler:    _KubeletApiServerService_DeleteDns_Handler,
		},
	},
