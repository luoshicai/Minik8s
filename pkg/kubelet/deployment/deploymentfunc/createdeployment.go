...
func CreateDeployment(deployment *entity.Deployment) ([]string, error) {
	...
	deployment.Status.Replicas = int32(Replicas - failedPod)
	return DeployContainerIDMap, nil
}
